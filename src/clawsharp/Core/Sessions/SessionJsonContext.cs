...
[JsonSerializable(typeof(Session)), JsonSerializable(typeof(List<ChatMessage>)), JsonSerializable(typeof(ChatMessage)),
 ...
 JsonSerializable(typeof(FileAttachment)), JsonSerializable(typeof(IReadOnlyList<FileAttachment>)),
 JsonSerializable(typeof(AudioAttachment)),
 JsonSerializable(typeof(VideoAttachment)), JsonSerializable(typeof(IReadOnlyList<VideoAttachment>)),
